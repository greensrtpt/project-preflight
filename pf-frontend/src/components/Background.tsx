...
export const Background: React.FC<BackgroundLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-[#fbf9f4] transition-colors z-0">
      ...
      <div 
        className="absolute inset-0 pointer-events-none opacity-100 transition-opacity"
        style={{
          backgroundImage: `
            radial-gradient(at 0% 100%, #F2BEED 0px, transparent 50%),
            radial-gradient(at 50% 50%, #F3F5E7 0px, transparent 100%),
            radial-gradient(at 30% 30%, #F3F5E7 0px, transparent 100%),
